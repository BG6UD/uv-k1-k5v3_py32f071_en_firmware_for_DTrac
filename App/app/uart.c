...
void UART_HandleCommand(uint32_t Port)
{
    ...
    case 0x8888:
        CMD_8888(Port, pUART_Command->Buffer); // for DTrac app downFreq
        break;

    case 0x7777:
        CMD_7777(pUART_Command->Buffer); // for DTrac app upFreq
        break;

    case 0x6666:
        CMD_6666(pUART_Command->Buffer); // for DTrac app mode
        break;
